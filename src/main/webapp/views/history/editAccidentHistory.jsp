        ...
        <div class="card-body">
            <form action="${pageContext.request.contextPath}/accidentHistory" method="post">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="accidentType" name="accidentType" value="${accident.accidentType}" <c:if test="${accident.status != 'Pending'}">readonly</c:if> required>
                </div>
                <div class="mb-3">
                    <label for="description" class="form-label">Description:</label>
                    <input type="text" class="form-control" id="description" name="description" value="${accident.description}" <c:if test="${accident.status != 'Pending'}">readonly</c:if> required>
                </div>
                <div class="mb-3">
                    <label for="accidentDate" class="form-label">Accident Date:</label>
                    <input type="date" class="form-control" id="accidentDate" name="accidentDate" value="<fmt:formatDate pattern='yyyy-MM-dd' value='${accident.accidentDate}' />" <c:if test="${accident.status != 'Pending'}">readonly</c:if> required>
                </div>
                <div class="mb-3">
