...
<div id="tp-footer-two" class="tp-footer-two"><!-- footer -->
    <div class="container">
        <div class="row ft-section">
            <div class="col-md-4 ft-logo"><img src="${pageContext.request.contextPath}/img/logo.png" alt="logo"></div>
        ...
        <div class="row ft-section">
            ...
            <div class="col-md-5 ft-aboutus"> <!-- ft aboutus -->
                ...
                <p>Established in 1990, we are your insurance expert committed to providing peace of mind to all kinds
                    of borrowers by helping them obtain and manage a insurance.</p>
        ...
        <div class="row">
            <div class="col-md-6 copyright-text"><!-- copyright text -->
                Copyright 2015. Peace Insurance Company. All Rights Reserved.
            </div>
            <!-- /.copyright text -->
