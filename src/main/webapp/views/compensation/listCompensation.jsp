...
<c:set var="page" value="compensation"/>
...
<div class="main-content ml-64 p-6">
    <div class="container mx-auto mt-5">
        <div class="card p-8 shadow-lg rounded-lg bg-white animate__animated animate__fadeIn">
            <h2 class="text-center text-4xl font-semibold text-gray-700 mb-6">Compensation Management System</h2>
            ...
            <form class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6" method="get" action="${pageContext.request.contextPath}/listCompensation">
                <div>
            ...
            <div class="overflow-x-auto">
                <table class="min-w-full bg-white divide-y divide-gray-200 shadow overflow-hidden sm:rounded-lg">
                    ...
                    <tr>
                        ...
                        <th class="px-6 py-3 text-left text-xs font-medium text-gray-100 uppercase tracking-wider">Amount</th>
                    ...
                    <c:forEach var="compensation" items="${requests}" varStatus="status">
                        <tr class="hover:bg-gray-100 transition duration-150 ease-in-out">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap"><c:out value="${compensation.customerID}"/></td>
                            <td class="px-6 py-4 whitespace-nowrap"><c:out value="${compensation.contractID}"/></td>
                            <td class="px-6 py-4 whitespace-nowrap"><c:out value="${compensation.customerName}"/></td>
                            <td class="px-6 py-4 whitespace-nowrap"><c:out value="${compensation.description}"/></td>
                            <td class="px-6 py-4 whitespace-nowrap"><fmt:formatNumber value="${compensation.amount}" type="currency" currencySymbol="$"/></td>
                            <td class="px-6 py-4 whitespace-nowrap ${compensation.status == 'Pending' ? 'text-yellow-600' : compensation.status == 'Approved' ? 'text-green-600' : compensation.status == 'Rejected' ? 'text-red-600' : ''}">
                                <c:out value="${compensation.status}"/>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap"><fmt:formatDate value="${compensation.requestDate}" pattern="dd-MM-yyyy"/></td>
