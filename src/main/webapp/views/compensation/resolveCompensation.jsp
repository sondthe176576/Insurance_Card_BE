        ...
        <div class="card-body mt-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div class="flex flex-col">
                    <label class="font-bold text-gray-700">Compensation ID:</label>
                    <p class="bg-gray-100 p-2 rounded"><c:out value="${compensation.requestID}"/></p>
                </div>
                <div class="flex flex-col">
                    <label class="font-bold text-gray-700">Description:</label>
                    <p class="bg-gray-100 p-2 rounded"><c:out value="${compensation.description}"/></p>
                </div>
                <div class="flex flex-col">
                    <label class="font-bold text-gray-700">Amount:</label>
                    <p class="bg-gray-100 p-2 rounded"><fmt:formatNumber value="${compensation.amount}" type="currency" currencySymbol="$"/></p>
                </div>
                <div class="flex flex-col">
                    <label class="font-bold text-gray-700">Status:</label>
                    <p class="bg-gray-100 p-2 rounded"><c:out value="${compensation.status}"/></p>
                </div>
                <div class="flex flex-col">
                    <label class="font-bold text-gray-700">Date:</label>
                    <p class="bg-gray-100 p-2 rounded"><fmt:formatDate value="${compensation.requestDate}" pattern="dd-MM-yyyy"/></p>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div class="flex flex-col">
                    ...
                    <p class="bg-gray-100 p-2 rounded"><c:out value="${compensation.contract.customer.user.fullName}"/></p>
                </div>
                <div class="flex flex-col">
                    <label class="font-bold text-gray-700">First Name:</label>
                    <p class="bg-gray-100 p-2 rounded"><c:out value="${compensation.contract.customer.user.firstName}"/></p>
                </div>
                <div class="flex flex-col">
                    <label class="font-bold text-gray-700">Last Name:</label>
                    <p class="bg-gray-100 p-2 rounded"><c:out value="${compensation.contract.customer.user.lastName}"/></p>
                </div>
                <div class="flex flex-col">
                    <label class="font-bold text-gray-700">Phone Number:</label>
                    <p class="bg-gray-100 p-2 rounded"><c:out value="${compensation.contract.customer.user.mobile}"/></p>
                </div>
                <div class="flex flex-col">
                    <label class="font-bold text-gray-700">Email:</label>
                    <p class="bg-gray-100 p-2 rounded"><c:out value="${compensation.contract.customer.user.email}"/></p>
                </div>
                <div class="flex flex-col">
                    <label class="font-bold text-gray-700">Province:</label>
                    <p class="bg-gray-100 p-2 rounded"><c:out value="${compensation.contract.customer.user.province}"/></p>
                </div>
                <div class="flex flex-col">
                    <label class="font-bold text-gray-700">District:</label>
                    <p class="bg-gray-100 p-2 rounded"><c:out value="${compensation.contract.customer.user.district}"/></p>
                </div>
                <div class="flex flex-col">
                    <label class="font-bold text-gray-700">Country:</label>
                    <p class="bg-gray-100 p-2 rounded"><c:out value="${compensation.contract.customer.user.country}"/></p>
                </div>
                <div class="flex flex-col">
                    <label class="font-bold text-gray-700">Gender:</label>
                    <p class="bg-gray-100 p-2 rounded"><c:out value="${compensation.contract.customer.user.gender}"/></p>
                </div>
                <div class="flex flex-col">
                    <label class="font-bold text-gray-700">Birth Date:</label>
                    <p class="bg-gray-100 p-2 rounded"><fmt:formatDate value="${compensation.contract.customer.user.birthDate}" pattern="dd-MM-yyyy"/></p>
                </div>
                <div class="flex flex-col">
                    <label class="font-bold text-gray-700">Personal Info:</label>
                    <p class="bg-gray-100 p-2 rounded"><c:out value="${compensation.contract.customer.personalInfo}"/></p>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div class="flex flex-col">
                    ...
                    <p class="bg-gray-100 p-2 rounded"><c:out value="${compensation.contractID}"/></p>
                </div>
                <div class="flex flex-col md:col-span-2">
                    <label class="font-bold text-gray-700">Contract Info:</label>
                    <p class="bg-gray-100 p-2 rounded"><c:out value="${compensation.contract.contractInfo}"/></p>
                </div>
                <div class="flex flex-col">
                    <label class="font-bold text-gray-700">Contract Status:</label>
                    <p class="bg-gray-100 p-2 rounded"><c:out value="${compensation.contract.status}"/></p>
                </div>
                <div class="flex flex-col">
                    <label class="font-bold text-gray-700">Start Date:</label>
                    <p class="bg-gray-100 p-2 rounded"><fmt:formatDate value="${compensation.contract.startDate}" pattern="dd-MM-yyyy"/></p>
                </div>
                <div class="flex flex-col">
                    <label class="font-bold text-gray-700">End Date:</label>
                    <p class="bg-gray-100 p-2 rounded"><fmt:formatDate value="${compensation.contract.endDate}" pattern="dd-MM-yyyy"/></p>
                </div>
                <div class="flex flex-col">
                    <label class="font-bold text-gray-700">Insurance Type:</label>
                    <p class="bg-gray-100 p-2 rounded"><c:out value="${compensation.contract.insuranceType}"/></p>
                </div>
                <div class="flex flex-col">
                    <label class="font-bold text-gray-700">Coverage:</label>
                    <p class="bg-gray-100 p-2 rounded"><c:out value="${compensation.contract.coverage}"/></p>
                </div>
                <div class="flex flex-col">
                    <label class="font-bold text-gray-700">Premium:</label>
                    <p class="bg-gray-100 p-2 rounded"><fmt:formatNumber value="${compensation.contract.premium}" type="currency" currencySymbol="$"/></p>
                </div>
                <div class="flex flex-col md:col-span-2">
                    <label class="font-bold text-gray-700">Detail:</label>
                    <p class="bg-gray-100 p-2 rounded"><c:out value="${compensation.contract.detail}"/></p>
                </div>
                <div class="flex flex-col md:col-span-2">
                    <label class="font-bold text-gray-700">Value:</label>
                    <p class="bg-gray-100 p-2 rounded"><fmt:formatNumber value="${compensation.contract.value}" type="currency" currencySymbol="$"/></p>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div class="flex flex-col">
                    ...
                    <p class="bg-gray-100 p-2 rounded"><c:out value="${compensation.contract.motorcycle.brand}"/></p>
                </div>
                <div class="flex flex-col">
                    <label class="font-bold text-gray-700">Model:</label>
                    <p class="bg-gray-100 p-2 rounded"><c:out value="${compensation.contract.motorcycle.model}"/></p>
                </div>
                <div class="flex flex-col">
                    <label class="font-bold text-gray-700">Frame Number:</label>
                    <p class="bg-gray-100 p-2 rounded"><c:out value="${compensation.contract.motorcycle.frameNumber}"/></p>
                </div>
                <div class="flex flex-col">
                    <label class="font-bold text-gray-700">Engine Number:</label>
                    <p class="bg-gray-100 p-2 rounded"><c:out value="${compensation.contract.motorcycle.engineNumber}"/></p>
                </div>
                <div class="flex flex-col">
                    <label class="font-bold text-gray-700">Year Of Manufacture:</label>
                    <p class="bg-gray-100 p-2 rounded"><c:out value="${compensation.contract.motorcycle.yearOfManufacture}"/></p>
                </div>
                <div class="flex flex-col">
                    <label class="font-bold text-gray-700">Color:</label>
                    <p class="bg-gray-100 p-2 rounded"><c:out value="${compensation.contract.motorcycle.color}"/></p>
                </div>
            </div>
            <form id="resolveForm" method="post" action="${pageContext.request.contextPath}/resolveCompensation">
                ...
                <div class="text-center mt-8">
                    <button type="button" onclick="showModal('Approved')" class="btn-custom bg-green-500 hover:bg-green-700 text-white py-2 px-4 rounded-md shadow-md transition transform hover:scale-105"
                            <c:if test="${compensation.status == 'Approved' || compensation.status == 'Rejected'}">disabled</c:if>>
                    ...
                    <a href="${pageContext.request.contextPath}/listCompensation" class="btn-custom bg-gray-500 hover:bg-gray-700 text-white py-2 px-4 rounded-md shadow-md transition transform hover:scale-105 ml-4">
                        <i class="fas fa-arrow-left"></i> Back to List
                    </a>
                </div>
                <c:if test="${compensation.status == 'Approved' || compensation.status == 'Rejected'}">
