                        ...
                        <div class="container">
                            ...
                            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                                <ul class="nav navbar-nav">
                                    ...
                                    </li>   <li class="dropdown"> <a href="${pageContext.request.contextPath}/views/staff/ManageCustomer.jsp" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">ManagerCustomer <i class="fa fa-angle-down"></i></a>
                                    <ul class="dropdown-menu" role="menu">
