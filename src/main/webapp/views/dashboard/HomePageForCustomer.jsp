...
<nav>
    <div class="container">
        <ul class="nav-links">
            <li><a href="${pageContext.request.contextPath}/" class="font-bold uppercase hover:text-orange-500"><i class="fas fa-home mr-2"></i>Home</a></li>
            <li><a href="${pageContext.request.contextPath}/login" class="font-bold uppercase hover:text-orange-500"><i class="fas fa-file-contract mr-2"></i>Buy Insurance</a></li>
            <li><a href="${pageContext.request.contextPath}/login" class="font-bold uppercase hover:text-orange-500"><i class="fas fa-info-circle mr-2"></i>About</a></li>
            <li><a href="${pageContext.request.contextPath}/contractForCustomer" class="font-bold uppercase hover:text-orange-500"><i class="fas fa-file-alt mr-2"></i>Contract</a></li>
            <li><a href="${pageContext.request.contextPath}/views/dashboard/customerDashboard.jsp" class="font-bold uppercase hover:text-orange-500"><i class="fas fa-tachometer-alt mr-2"></i>Dashboard</a></li>
        </ul>
    </div>
</nav>
