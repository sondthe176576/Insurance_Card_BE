...
<!-- End of navbar -->
<!-- Form -->
<div class="container mt-5 accident-form-section">
    <div class="card p-4 shadow-sm">
        <h2 class="text-center mb-4">Accident Management</h2>
        <form method="get" class="row g-3 accident-form" action="${pageContext.request.contextPath}/listAccident">
            <div class="col-md-4">
        ...
        <table class="table table-hover mt-4">
            ...
            <c:forEach var="accident" items="${accidents}" varStatus="status">
                <tr>
                    ...
                    <td>
                        <a href="${pageContext.request.contextPath}/resolveAccident?accidentID=${accident.accidentID}" class="btn btn-info btn-sm"><i class="bi bi-eye-fill"></i> View</a>
                    </td>
                </tr>
            </c:forEach>
            </tbody>
        ...
        <nav aria-label="Page navigation example">
            <ul class="pagination justify-content-end">
                <c:if test="${currentPage > 1}">
                    <li class="page-item">
                        <a class="page-link" href="${pageContext.request.contextPath}/listAccident?page=${currentPage - 1}&status=${param.status}&customerName=${param.customerName}">
                ...
                <c:forEach var="i" begin="1" end="${totalPages}">
                    <c:if test="${i >= currentPage - 1 && i <= currentPage + 1}">
                        <li class="page-item ${i == currentPage ? 'active' : ''}">
                            <a class="page-link" href="${pageContext.request.contextPath}/listAccident?page=${i}&status=${param.status}&customerName=${param.customerName}">${i}</a>
                        </li>
                    </c:if>
                </c:forEach>
