...
<div class="main-content ml-64 p-6">
    <div class="container mx-auto mt-5">
        <div class="card p-8 shadow-lg rounded-lg bg-white animate__animated animate__fadeIn">
            <h2 class="text-center text-4xl font-semibold text-gray-700 mb-6">Accident Management System</h2>
            ...
            <form class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6" method="get" action="${pageContext.request.contextPath}/listAccident">
                <div>
            ...
            <div class="overflow-x-auto">
                <table class="min-w-full bg-white divide-y divide-gray-200 shadow overflow-hidden sm:rounded-lg">
                    ...
                    <tr>
                        ...
                        <th class="px-6 py-3 text-left text-xs font-medium text-gray-100 uppercase tracking-wider">Accident Type</th>
                        <th class="px-6 py-3 text-left text-xs font-medium text-gray-100 uppercase tracking-wider">Accident Date</th>
                    ...
                    <c:forEach var="accident" items="${accidents}" varStatus="status">
                        <tr class="hover:bg-gray-100 transition duration-150 ease-in-out">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap"><c:out value="${accident.customerID}"/></td>
                            <td class="px-6 py-4 whitespace-nowrap"><c:out value="${accident.customerName}"/></td>
                            <td class="px-6 py-4 whitespace-nowrap"><c:out value="${accident.contractID}"/></td>
                            <td class="px-6 py-4 whitespace-nowrap"><c:out value="${accident.accidentType}"/></td>
                            <td class="px-6 py-4 whitespace-nowrap"><fmt:formatDate value="${accident.accidentDate}" pattern="yyyy-MM-dd"/></td>
                            <td class="px-6 py-4 whitespace-nowrap"><c:out value="${accident.description}"/></td>
                            <td class="px-6 py-4 whitespace-nowrap ${accident.status == 'Pending' ? 'text-yellow-600' : accident.status == 'Approved' ? 'text-green-600' : accident.status == 'Rejected' ? 'text-red-600' : ''}">
