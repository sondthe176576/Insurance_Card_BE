        ...
        <div class="card-body p-4">
            <form id="renewContractForm" action="${pageContext.request.contextPath}/renewContract" method="post">
                ...
                <div class="row mt-4">
                    <div class="col-md-6">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="date" id="endDate" name="endDate" class="form-control"
                                   value="<fmt:formatDate value='${contract.endDate}' pattern='yyyy-MM-dd'/>" readonly>
                        </div>
                        <div class="mb-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" id="newPremium" name="newPremium" class="form-control" step="50"
                                   min="50" required>
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" id="newContractInfo" name="newContractInfo" class="form-control"
                                   required>
                        </div>
                    </div>
                </div>
                ...
                <div class="d-flex justify-content-center mt-4">
                    <button type="submit" class="btn btn-primary me-2"><i class="fas fa-file-signature"></i> Renew
                        Contract
                    </button>
                    <a href="${pageContext.request.contextPath}/listRenewContract" class="btn btn-secondary"><i
